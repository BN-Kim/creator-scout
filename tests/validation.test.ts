...
const validInput: NewRunInput = { name: "뷰티 탐색", category: "뷰티", keywords: "스킨케어", targetCount: 50, maximumDaysSinceLatestUpload: 56, minimumRecentAverageViews: 10000, minimumRecentVideoCount: 2 };
