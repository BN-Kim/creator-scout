...
describe("automatic scouting time limit", () => {
  ...
  it("formats a live countdown and never displays negative time", () => {
    expect(formatRunCountdown(remainingRunTimeMs(1_000, 1_000, automaticScoutingRunLimitMs))).toBe("01:00");
    expect(formatRunCountdown(remainingRunTimeMs(1_000, 2_001, automaticScoutingRunLimitMs))).toBe("00:59");
