...
확인된 크리에이터 신원과 검증 근거를 결정론적 규칙으로 평가하고, 추천·보류·제외 결과를 내부 히스토리에 기록하는 Next.js 운영 애플리케이션입니다. 현재 단계는 실제 외부 데이터를 사용하지 않는 2단계 목 애플리케이션이며 H0 하네스와 H1 UI 스모크 테스트가 완료되었습니다.
