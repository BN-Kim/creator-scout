...
export const reasonExplanations: Record<ReasonCode, string> = {
  ...
  missing_email: "개인 이메일이 확인되지 않아 보류되었습니다.", email_not_checked: "이메일을 아직 확인하지 않아 보류되었습니다.", email_ownership_unknown: "이메일 소유 유형이 명확하지 않아 보류되었습니다.", missing_verification: "필수 검증 근거가 일부 누락되어 보류되었습니다.", subscriber_threshold_not_configured: "구독자 기준이 설정되지 않아 구독자 수는 판정에 사용하지 않았습니다.",
