...
export default function SettingsPage(): React.ReactNode {
  ...
  useEffect(() => { try { setSettings(loadRecommendationSettings(window.localStorage)); } catch (caught) { console.error("저장된 설정을 불러오지 못했습니다.", caught); setError("저장된 설정이 유효하지 않아 기본값을 사용합니다."); } }, []);
